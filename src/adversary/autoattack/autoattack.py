...
class AutoAttack():
    ...
    def run_standard_evaluation(self, x_orig, y_orig, bs=250):
        ...
        with torch.no_grad():
            ...
            # robust flag: indicate whether an example is attacked successfully
            ...
            for attack in self.attacks_to_run:
                ...
                # If robust flag == 1: not successful yet, still need to attack
        ...
        return x_adv, robust_accuracy, robust_flags
